...
<div style="border:none;position:absolute;left:0px;top:0px;width:100%;height:100%;background-color:white;display:block;">
	<table border="0" width="100%" style="height:100%">
		<tr><td height="100%" valign="middle" align="center" style="text-align:center">
			<?php echo __('It appears that you attempted to submit an invalid request to the server'); ?>.<br />
			<?php echo __('The request has been denied. Reloading the page might solve the problem'); ?>.
			</td>
		</tr>
	</table>
</div>
<script type="text/javascript" language="javascript">
	window.title = "<?php echo __('Access Denied'); ?> !";
</script>
</body></html>
